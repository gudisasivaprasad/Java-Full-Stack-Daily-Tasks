...
public class Zomato{
	void main() {
		Order order = new Order("1","Panner butter Masala",250);
		Customer cust = new Customer("Name","giss@gmail.com","ameerepeta",986532741,order);
		IO.println(cust);
...
class Order {
	...
	@Override
	public String toString() {
		return "Zomato [orderId=" + orderId + ", itemName=" + itemName + ", price=" + price + "]";
	}
