...
class CreditCardPayment implements Payment {
    ...
    public void makePayment(double amount) {
        IO.print("Paid RS :" + amount + "using  Credit Card Holder: " + cardHolderName);

    }

    public void makeRefund(double amount) {
        IO.println("Refunded RS" + amount + "to Card Holder" + cardHolderName);
    }
}
...
class UPIPayment implements Payment{
    ...
    public UPIPayment (String upiId){
        ...
        public void makePayment(double amount) {
        System.out.println("Paid RS :" + amount + " using Debit Card Bank: " + upiId);
    }

    @Override
    public void makeRefund(double amount) {
        System.out.println("Refunded RS :" + amount + " to Debit Card Bank: " + upiId);
    }
...
public class Customer {
    ...
    public static void main(String[] args) {
        ...
        IO.println("Enter your total bill Amount :");
        ...
        switch (choice) {
            ...
            default:
                IO.println("Invalid Payment Option");
                return;
        }
